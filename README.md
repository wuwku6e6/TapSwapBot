[<img src="https://img.shields.io/badge/Telegram-%40Me-orange">](https://t.me/tapswap_mirror_bot?start=r_592067579)
...
## [Settings](https://github.com/wuwku6e6/TapSwapBot/blob/main/.env-example)
| Настройка                | Описание                                                                                 |
|--------------------------|------------------------------------------------------------------------------------------|
...
## Installation
You can download [**Repository**](https://github.com/wuwku6e6/TapSwapBot) by cloning it to your system and installing the necessary dependencies:
```shell
~ >>> git clone https://github.com/wuwku6e6/TapSwapBot.git
~ >>> cd TapSwapBot

# If you are using Telethon sessions, then clone the "converter" branch
~ >>> git clone https://github.com/wuwku6e6/TapSwapBot.git -b converter
~ >>> cd TapSwapBot
